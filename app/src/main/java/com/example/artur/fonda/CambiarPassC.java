...
public class CambiarPassC extends AppCompatActivity implements View.OnClickListener {
EditText et_pass;
TextView et_user;
Button bt_cambiar;
//ProgressBar progressbar1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cambiar_pass_c);
    ...
    class async1 extends AsyncTask<String,Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                String peticion = "Select * from Cliente where nombreuser='" + user + "'and password='" + pass + "'";
        ...
        protected void onPostExecute(String s) {
            ...
            if (isSuccess) {
                Intent e = new Intent(getApplicationContext(), PassC.class);
                e.putExtra("usuario",et_user.getText().toString());
                startActivity(e);
                //Toast.makeText(CambiarPassC.this, "Cambio realizado", Toast.LENGTH_LONG).show();
                //finish();
                et_pass.setText("");
                //et_user.setText("");
            }
