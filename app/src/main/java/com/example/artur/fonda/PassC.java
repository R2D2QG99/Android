...
public class PassC extends AppCompatActivity implements View.OnClickListener {
    EditText et_pass;
    TextView et_user;
    Button bt_cambiar;
    ...
    class async1 extends AsyncTask<String,Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                String peticion = "Update Cliente Set password='" + pass + "'where nombreuser='" + user +"'";
        ...
        protected void onPostExecute(String s) {
            ...
            if (isSuccess) {
                ...
                startActivity(e);
                Toast.makeText(PassC.this, "Cambio realizado", Toast.LENGTH_LONG).show();
                //finish();
                et_pass.setText("");
            }
        }
